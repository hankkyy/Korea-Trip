...
- Service Worker 当前版本：`lu-travel-v61`。
...
- 灵感箱：`kr_inspirations` 使用既有 protocol 2 同步。首页收集箱内提供入口；桌面和 iPhone 读取剪贴板后先给出可编辑的标题、归类、地点和备注确认卡，Android 已安装 PWA 可从系统分享面板接收标题、文字与 URL，并打开同一张确认卡。
