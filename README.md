...
- PWA：Add to Home Screen（standalone 模式）+ Service Worker 离线壳（缓存版本 `korea-trip-v15`）
...
- 首尔酒店：Courtyard by Marriott Seoul Myeongdong，入住 2026-12-29 15:00，退房 2027-01-03 11:00，确认号 #93241473。
