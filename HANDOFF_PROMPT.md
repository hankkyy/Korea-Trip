...
更新时间：2026-09-11
当前源码基线：2026-09-11 上线候选；Service Worker：`lu-travel-v78`
...
私有附件代码链路已经统一，但仍需可乐、金鹿用各自真实账号与设备分别上传、预览和下载同一文件。还需完成双设备弱网冲突、后台恢复、PWA 升级和中国大陆/韩国网络验收。未完成这些人工项前，不得宣称真实设备矩阵全部通过。
